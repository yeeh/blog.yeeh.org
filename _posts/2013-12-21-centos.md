...
在data/web/site1/下放一个index.php，可以访问
...
上面最后2行不能少，就是少了这个，结果root上去启动mysql正常，但是一看版本就报连不上/var/lib/mysql/mysql.sock，在这走了不少弯路，结果是1没有指示客户端sock连到哪里，二是没有指定用tcp连

我没有修改/etc/init.d/mysql这个文件，这个下面也有指定datadir的目录
